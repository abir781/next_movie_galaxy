...
const Genrebasedpage =async({id}) => {

   
    

    const res = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=e0b1a5f59bc00cdc9da099c36c7fb253&with_genres=${id}`);
